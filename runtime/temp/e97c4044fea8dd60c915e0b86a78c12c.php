<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"D:\wmPhp\wamp\www\advance_dabao\zwadmin\application\advance\view\index\service_details.html";i:1520312475;s:81:"D:\wmPhp\wamp\www\advance_dabao\zwadmin\application\advance\view\common\base.html";i:1511767701;s:83:"D:\wmPhp\wamp\www\advance_dabao\zwadmin\application\advance\view\common\header.html";i:1520233728;s:83:"D:\wmPhp\wamp\www\advance_dabao\zwadmin\application\advance\view\common\footer.html";i:1520311876;}*/ ?>
<!doctype html>
<html lang="">
<head>
  <meta charset="utf-8">
    ...
    <div class="flex-container-wrapper mb--l">
      ...
      <div class="flex-mask">
        <div class="diagnose logvilad" >
          ...
          <div class="diagnose-text">开始</div>
        </div>
        ...
        <div class="expert-example-wrapper clearfix">
          ...
          <div class="expert">
            ...
            <div class="expert-details">
              ...
              <span class="expert-info"><span>加州大学，旧金山奥舍综合医学中心</span><!-- <span>旧金山总医院主任</span> --><span>血液科/肿瘤科</span></span>
            </div>
          </div>
        ...
        <div class="diagnose-process-wrapper2 clearfix">
          <div class="diagnose-step">
            <div class="step-wrapper">
              ...
              <div class="diagnose-step-context">
                <div class="diagnose-step-text">
                  <span class="step-title">专家医疗意见服务场景</span>
                  <span class="step-text">
                  专家医疗意见服务案例
                  </span>
                  <ul>
                    <li>当您对于已有的疾病诊断有疑虑，需要专家确认的时候</li>
                    <li>当您患有重大疾病例如癌症，心脏病时，想了解对于目前治疗方案是否还有的其他治疗选项</li>
                    <li>当您面临重大医疗决策的时候，例如是否有手术的必要</li>
                    <li>当您对于病症在不同的医院得到不同的诊断感到困惑时</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="diagnose-step">
            <div class="step-wrapper">
              ...
              <div class="diagnose-step-context">
                <div class="diagnose-step-text">
                  <span class="step-title">不适用于专家医疗意见服务的场景</span>
                  <span class="step-text"">以下场景不适用于专家医疗意见服务</span>
                  <!-- <span class="step-text">
                  ...
                  <ul>
                    <li>急诊</li>
                    <li> 意外</li>
                    <li>随时危急生命的情况，例如在重症监护室留观期，生命体征不稳定的危重情况</li>
                    <li>日常健康咨询，例如感冒发烧、头痛、初发皮疹等</li>
                  </ul>
                </div>
              </div>
            </div>
...
<div class="bottom-nav-wrapper clearfix">
      <ul class="bottom-nav">
        <li ><a href="<?php echo url('/services/1'); ?>#diagnose">关于汇医</a></li>
        <li ><a href="<?php echo url('/services/1'); ?>#foreign">专家医疗意见</a></li>
    ...
    <div class="medical-footer">
      <div class="medical-footer-text"><!-- 汇医健康顾问门户网站所提供的服务旨在向用户提供医疗咨询。在任何情况下，这些咨询服务仅应被视为医疗咨询的建议。而这些医疗咨询的建议是根据客户提供的医疗信息所做出的，并不能取代专业医疗机构的医疗诊断。 -->汇医提供的独立医疗意见服务将不涉及任何形式的医学诊断，治疗以及开具处方。</div>
    </div>
  </div>
  <div class="app-mask">
  </div>
